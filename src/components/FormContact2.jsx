    ...
    <div className="container mx-auto flex min-h-screen flex-col px-6 py-12">
        ...
        <div className="text-white lg:mx-6 lg:w-1/2">
            ...
            <p className="-mx-2 flex items-start">
                ...
                <span className="mx-2 w-72 truncate text-white"> Salta Nº 4632, C.A.B.A. </span>
            </p>
            ...
            <p className="-mx-2 flex items-start">
                ...
                <span className="mx-2 w-72 truncate text-white">(11) 563-7401</span>
            </p>
            ...
            <p className="-mx-2 flex items-start">
                ...
                <span className="mx-2 w-72 truncate text-white">Burger4U@example.com</span>
            </p>
            </div>
            ...
            <div className="-mx-1.5 mt-4 flex">
                ...
                <a className="mx-1.5 transform text-white transition-colors duration-300 hover:text-blue-500" href="https://www.linkedin.com/">
                ...
                <a className="mx-1.5 transform text-white transition-colors duration-300 hover:text-blue-500" href="https://www.facebook.com/">
                <svg className="h-8 w-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 10.2222V13.7778H9.66667V20H13.2222V13.7778H15.8889L16.7778 10.2222H13.2222V8.44444C13.2222 8.2087 13.3159 7.9826 13.4826 7.81591C13.6493 7.64921 13.8754 7.55556 14.1111 7.55556H16.7778V4H14.1111C12.9324 4 11.8019 4.46825 10.9684 5.30175C10.1349 6.13524 9.66667 7.2657 9.66667 8.44444V10.2222H7Z" fill="currentColor" />
                </svg>
                </a>

                <a className="mx-1.5 transform text-white transition-colors duration-300 hover:text-blue-500" href="https://www.instagram.com/">
                <svg className="h-8 w-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
