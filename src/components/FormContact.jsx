...
export default function CarouselPrueba() {
    const slides = [
        {
          url: carouselImg[3],
    ...
    return (
        <>
        <h2 className=" text-3xl tracking-tight  text-center text-white dark:text-white">Promos especiales</h2>
        <div className='max-w-[1200px] h-[500px] w-full m-auto py-7 px-4 relative group'>
