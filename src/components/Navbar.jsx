            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="container-icon">
                ...
                >
                  {allProducts?.length ? (
                    <>
                      <div className="row-product h-72 overflow-y-scroll">
                        {allProducts?.map((product) => (
                          <div className="cart-product" key={product.id}>
                            <div className="info-cart-product ">
                              <span className="text-sm cantidad-producto-carrito">
                                {product.quantity}
                              </span>
                              <p className="text-sm titulo-producto-carrito text-center">
                                {product.name}
                              </p>
                              <span className="text-sm precio-producto-carrito">
                                ${product.price}
                              </span>
                            </div>
                            <svg 
                      ...
                      <a className="btn-comprar " href="/ConfirmarCompra"> 
                        <span>Comprar $ {total}</span>
                      </a>                    
                      <button className="btn-clear-all text-xs font-medium" onClick={clearCart}>
                        Vaciar Carrito
                      </button>                       
